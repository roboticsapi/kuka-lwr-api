...
public class LwrJointImpedanceController extends AbstractPositionController {
	private final ImpedanceSpringSetting[] jointImpedances;

	public LwrJointImpedanceController(double stiffness, double damping) {
		this(new ImpedanceSpringSetting[] { new ImpedanceSpringSetting(stiffness, damping),
				new ImpedanceSpringSetting(stiffness, damping), new ImpedanceSpringSetting(stiffness, damping),
				new ImpedanceSpringSetting(stiffness, damping), new ImpedanceSpringSetting(stiffness, damping),
				new ImpedanceSpringSetting(stiffness, damping), new ImpedanceSpringSetting(stiffness, damping) });
	}

	public LwrJointImpedanceController(ImpedanceSpringSetting[] jointImpedances) {
		super();
	...
	public LwrJointImpedanceController(ImpedanceSpringSetting jointImpedance0, ImpedanceSpringSetting jointImpedance1,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof LwrJointImpedanceController)) {
			return false;
		}

		LwrJointImpedanceController other = (LwrJointImpedanceController) obj;
